 ...
 * worksheet
 */
public class CommentBiff8 implements Comment
{
  /**
   * The logger
   */
  private static Logger logger = Logger.getLogger(CommentBiff8.class);
   ...
   */
  public CommentBiff8(MsoDrawingRecord msorec, ObjRecord obj, DrawingData dd,
                 DrawingGroup dg)
  {
    drawingGroup = dg;
   ...
   * @param ws the workbook settings
   */
  /*protected*/ public CommentBiff8(DrawingGroupObject dgo,
                               DrawingGroup dg)
  {
    CommentBiff8 d = (CommentBiff8) dgo;
   ...
   * @param r the row
   */
  public CommentBiff8(String txt, int c, int r)
  {
    initialized = true;
    origin = Origin.WRITE;
    column = c;
  ...
  public boolean equals(Object obj)
  {
    ...
    if (getClass() != obj.getClass())
      return false;
    final CommentBiff8 other = (CommentBiff8) obj;
